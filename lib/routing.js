...
ProfileController = ReactionController.extend({
    ...
    waitOn:function(){
        return Meteor.subscribe("limitedProfile", this.params.userId); //isn't actually a username, is email address
        return Meteor.subscribe('profileProducts', this.params.userId);
    },
    // data:function(){
...
ProductController = ReactionController.extend({
  waitOn: function() {
