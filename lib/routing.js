...
ProfileController = ReactionController.extend({
    ...
    waitOn:function(){
        //return Meteor.subscribe("directory");
        return Meteor.subscribe("userProfile", this.params.username); //isn't actually a username, is email address
        //return Meteor.subscribe('userProductsByUser', this.params._id);
        return Meteor.subscribe('userProductsByEmail', this.params.username);
    },
    // data:function(){
